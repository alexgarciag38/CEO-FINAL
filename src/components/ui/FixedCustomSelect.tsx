...
interface FixedCustomSelectProps {
  value: string | null;
...
const FixedCustomSelect: React.FC<FixedCustomSelectProps> = ({
  value, 
  onChange, 
  options, 
  ...
  console.log('FixedCustomSelect render:', { value, selected, optionsCount: options.length });
  ...
  const handleOptionClick = (option: Option) => {
    ...
    console.log('FixedCustomSelect - Option clicked:', { option, currentValue: value, onChange: typeof onChange });
    
    if (typeof onChange === 'function') {
      console.log('FixedCustomSelect - Calling onChange with:', option.value);
      onChange(option.value);
    } else {
      console.error('FixedCustomSelect - onChange is not a function:', onChange);
    }
...
export default FixedCustomSelect;
