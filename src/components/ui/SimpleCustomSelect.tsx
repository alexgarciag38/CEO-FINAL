...
const SimpleCustomSelect: React.FC<SimpleCustomSelectProps> = ({
  value, 
  onChange, 
  options, 
  ...
  console.log('SimpleCustomSelect render:', { value, selected, optionsCount: options.length });
  ...
  const handleOptionClick = (option: Option) => {
    ...
    console.log('SimpleCustomSelect - Option clicked:', { option, currentValue: value, onChange: typeof onChange }); // Debug
    
    // Verificar que onChange existe y es una función
    if (typeof onChange === 'function') {
      console.log('SimpleCustomSelect - Calling onChange with:', option.value);
      onChange(option.value);
    } else {
      console.error('SimpleCustomSelect - onChange is not a function:', onChange);
    }
              ...
              return (
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    console.log('SimpleCustomSelect - Button clicked directly:', option);
